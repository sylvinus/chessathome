...
main() {
  ...
  ["rnbqkb1r/pp1p1ppp/2p5/4P3/2B5/8/PPP1NnPP/RNBQK2R w KQkq - 0 6", 42, 1352, 53392]
  
  
  ];
  
  num wrongCount = 0;
  for (var perft in g_perfTTable) {
    var b = new Board();
    ...
    for (var i=0;i<=N;i++) {
      if (i>=(perft.length-1)) continue;
      if (perft[1+i] != moves[i]) {
        print("WRONG MOVES COUNT for ${perft[0]} at $i : ${moves[i]} should be ${perft[1+i]}");
        print(b.getRepr());
        //return;
        wrongCount++;
      }
